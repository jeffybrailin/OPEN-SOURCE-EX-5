...
### STEP 7 :
sudo -u harry /bin/echo "hello" sudo -u harry /usr/bin/logger "RHCSA EXAM TRAINING"
### STEP 8 : 
journalctl | grep RHCSA

## Output:
<img width="1309" height="976" alt="image" src="https://github.com/user-attachments/assets/f672aad9-be48-41df-95d3-0673eb9ea505" />
